...
- JUnit 5 for running tests (download from https://junit.org/junit5/)

**Quick Setup for JUnit 5:**
1. Download JUnit 5 Platform Console Standalone from: https://repo1.maven.org/maven2/org/junit/platform/junit-platform-console-standalone/1.9.3/junit-platform-console-standalone-1.9.3.jar
2. Save it as `lib/junit-platform-console-standalone-1.9.3.jar`
3. Your `lib/` directory should contain:
    - `json-20240303.jar`
...
From the project root:
    ...
    javac -cp "lib/json-20240303.jar;lib/junit-platform-console-standalone-1.9.3.jar" -d out src/*.java

**Note:** If you don't have JUnit 5 installed, you can build just the main application files:
javac -cp "lib/json-20240303.jar" -d out src/AggregationServer.java src/ContentServer.java src/GETClient.java src/JSONUtils.java src/LamportClock.java

How to run the server
---------------------
- Default port (4567):

  java -cp "out;lib/json-20240303.jar" AggregationServer

- Custom port (example: 9000):

  java -cp "out;lib/json-20240303.jar" AggregationServer 9000
...
Send it to the server:
    ...
    java -cp "out;lib/json-20240303.jar" ContentServer localhost:4567 station.txt
...
- Get all stations:
  ...
  java -cp "out;lib/json-20240303.jar" GETClient localhost:4567

- Get one station by id:

  java -cp "out;lib/json-20240303.jar" GETClient localhost:4567 IDS60901
...
2) Run the suite:
   ...
   java -cp "out;lib/json-20240303.jar;lib/junit-platform-console-standalone-1.9.3.jar" TestRunner
